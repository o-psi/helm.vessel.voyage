...
<div class="flex items-center justify-between">
    ...
    <flux:modal name="message-details" class="w-full md:max-w-3xl">
        ...
        <template id="thread-tool-entry"><details class="group" data-tool-entry><summary class="flex cursor-pointer list-none items-center gap-2 py-2 text-sm"><flux:icon.chevron-right class="size-3 text-zinc-400 group-open:rotate-90" /><span data-entry-label class="min-w-0 flex-1 break-words"></span><time data-entry-time class="shrink-0 text-xs text-zinc-400"></time></summary><div data-entry-body class="max-h-96 overflow-auto rounded-lg bg-zinc-50 p-3 dark:bg-zinc-900"></div></details></template>
