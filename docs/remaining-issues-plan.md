...
- Policy foundation [#118](https://github.com/o-psi/voyage/pull/118) now integrates current main and fixture fix #119 at 0fd1a47. Its prior 522-test integration passed locally; one CI run exposed the independent attachment fixture failure now corrected in #119. Full integrated baseline and CI are rerunning. Actual runtime enforcement proceeds in an isolated #70 slice, with no host `/etc` mutation.
