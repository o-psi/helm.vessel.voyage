...
and recorded. Transient secret binding and TUI discovery/input forms remain future
work under [#67](https://github.com/o-psi/voyage/issues/67).
...
round trips and branching. TUI changes and native macOS/Windows execution are not
claimed; Linux is the verification gate. No live provider evaluation accompanies
