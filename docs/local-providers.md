...
including a symlink, is never replaced. Setup publication currently requires Linux
and a filesystem supporting anonymous `O_TMPFILE` staging plus `/proc/self/fd`.
