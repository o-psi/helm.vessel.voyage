...
fn legacy_v2(journal: &mut Journal) {
    journal
        .connection
        .execute_batch("DROP TABLE local_cleanup_obligations; DROP TABLE local_cancel_intents; DROP TABLE IF EXISTS steering; DROP TABLE imports; UPDATE attachment_schema SET version=2 WHERE id=1;")
        .unwrap();
