...
pub(super) use voyage_runtime::execution::ManagedExecution;
#[allow(clippy::too_many_arguments)]
pub(super) async fn execute_admitted(
    ...
    voyage_runtime::execution::execute_admitted(
        owner, run, config, workspace, sink, cancel, interrupt, authority, None,
    )
    .await
}
