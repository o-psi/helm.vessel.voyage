...
mod tests {
    use super::*;
    #[test]
    fn common_remotes_have_one_canonical_identity() {
        let expected = Repository::new("Owner", "Repo").unwrap();
        for value in [
            ...
            assert_eq!(Repository::from_remote(value).unwrap(), expected, "{value}");
        }
    }
    #[test]
    fn remote_cannot_change_host_or_inject_credentials_paths_or_options() {
        for value in [
            ...
            "https://github.com/o/r?host=evil",
            ...
            assert!(Repository::from_remote(value).is_err(), "{value}");
        }
    }
    #[test]
    fn object_identity_is_exact_and_never_an_arbitrary_url() {
        let object = Object::parse("https://github.com/O/R/pull/42").unwrap();
        assert_eq!(object.url(), "https://github.com/o/r/pull/42");
        for value in [
            "https://github.com/o/r/issues/0",
            "https://github.com/o/r/pull/42/files",
            "https://github.com/o/r/issues/4?x=1",
            "https://evil/o/r/issues/1",
            "https://github.com/o/r/issues/1#issuecomment-1",
            "https://github.com/o/r/issues/2147483648",
        ] {
