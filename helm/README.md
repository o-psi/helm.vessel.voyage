...
- Explicit [local inference allowances](../docs/inference-budgets.md), durable attempt accounting, [historical usage exploration](../docs/inference-history.md) and reasoned operator overrides
